...
module.exports = {
  name: "info",
  description: "Information About The Bot On Your DM",
  usage: "",
  permissions: {
    channel: ["VIEW_CHANNEL", "SEND_MESSAGES", "EMBED_LINKS"],
    member: [],
  },
  aliases: ["command", "commands", "cmd","about"],
  /**
   *
   ...
   */
   run: async (client, message, args, { GuildDB }) => {
    ...
    let Embed = new MessageEmbed()
            .setAuthor(
              `CMD/ABOUT OF ${client.user.username}`,
  ...
  **PATUKARAN: V${require("../package.json").version}**
  [✨ INVITE ME](${
    ...
    if (!args[0]) message.author.send(Embed);
    else {
      let cmd =
